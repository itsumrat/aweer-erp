                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <input id="datetimepicker" type="text" class="form-control" required value="{{ $transfer_return->date }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label>Reference No</label>
                                                            <input type="text" class="form-control" readonly="true" v-model="reference">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                        ...
                                                        <table id="adjustment-addition" class="table table-striped table-bordered" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="(item,index) in selected_items">
                                                                    ...
                                                                    <td><input type="number" class="form-control" v-model="selected_items[index].quantity" v-bind:name="getInputName(index, 'quantity')" required="required" v-on:keyup="countTotals"></td>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary btn-draft mt-3">draft</button>
