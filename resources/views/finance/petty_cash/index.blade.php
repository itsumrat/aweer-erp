...
@section('title', 'EI-365 | Manage Petty Cash')
...
@section('main_content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Manage Petty Cash(<span id="loc-text">All Locations</span>)</h5>
        ...
        <div class="modal fade" id="requisitionDelModal" tabindex="-1" role="dialog" aria-labelledby="requisitionDelModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="requisitionDelModalLabel">Delete Petty Cash Transaction</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
