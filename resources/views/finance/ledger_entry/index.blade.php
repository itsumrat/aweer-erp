...
@section('title', 'Dashboard - Transaction List')
...
@section('main_content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Transaction List(<span id="loc-text">All Locations</span>)</h5>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="statusUpdateModalLabel">Status Update Ledger</h5>
        ...
        <div class="modal fade" id="requisitionDelModal" tabindex="-1" role="dialog" aria-labelledby="requisitionDelModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="requisitionDelModalLabel">Delete Ledger Transaction</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body text-center">
                        <form>
                            <p>Want to delete the Transaction?</p>
                            <div>
...
<script>
 $(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        columns: [
            {data: 'date', name: 'date'},
            {data: 'subledger_id', name: 'subledger_id'},
