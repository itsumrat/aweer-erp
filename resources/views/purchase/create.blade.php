                                                        ...
                                                        <table class="table table-striped table-bordered" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="(item, index) in selected_items">
                                                                    ...
                                                                    <td>@{{ item.last_grn_cost }}</td>
                                                                    <td>
                                                                    
                                                                        <input class="form-control" type="text" v-bind:name="getInputName(index, 'cost')" v-model="selected_items[index].final_cost" readonly>
                                                                    </td>
                                                                    <td>
                                                                        <input type="hidden" v-bind:name="getInputName(index, 'barcode')" v-model="item.barcode">
                                                                        <input type="hidden" v-bind:name="getInputName(index, 'id')" v-model="item.product_id">
                                                                    ...
                                                                    <td>@{{ (selected_items[index].quantity * item.final_cost) - (((selected_items[index].quantity * item.final_cost)*selected_items[index].discount)/100) }}</td>
