                                        ...
                                        <table class="table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->quantity }}</td>
                                                    <td>{{ (($item->quantity * $item->item->prices->final_cost) - ((($item->quantity * $item->item->prices->final_cost) * $item->discount)/100)) * 0.05 }}</td>
                                                    <td>{{ $item->discount }}</td>
                                                    <td>{{ ($item->quantity * $item->item->prices->final_cost) - ((($item->quantity * $item->item->prices->final_cost) * $item->discount)/100) }}</td>
                                                </tr>
                                                @endforeach
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="6" style="text-align:right; padding-right:10px; font-weight:bold;">Total
                                                    </td>
                                                    <td colspan="2" style="text-align:right; padding-right:10px;"> AED</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align:right; padding-right:10px;"> AED
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;"> AED
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
