                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Promotion history(<span id="loc-text">All Locations</span>)</h5>
...
<script>
    var table = $('#promotional-history').DataTable({
        ...
        scrollX: true,
        ajax: {
            url:"{{ route('promotional_item_list') }}",
            data: function(data){
        ...
        columns: [
            ...
            {data: 'promo_date', name: 'promo_date'},
    ...
    function confirmDelete(){
        ...
        $.ajax({
            url: "{{ route('item_promotion_delete') }}",
            type: 'post',
            headers: {
