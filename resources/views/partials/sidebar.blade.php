                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <!--<li>-->
                                <!--    <a href="{{ route('cash_purchase.create') }}">cash purchase</a>-->
                                <!--</li>-->
                                <!--<li>-->
                                <!--    <a href="{{ route('cash_purchase.index') }}">manage cash purchase</a>-->
                                <!--</li>-->
                            </ul>
                        </li>
                        <li>
...
{{--                    <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('daily_cash_flow') }}">Cash Flow</a>
                                </li>
                                <li>
                                    <a href="{{ route('daily_bank_flow') }}">Bank Flow</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('warehouse') }}">Warehouse GUI</a>
                                </li>
                                <li>
                                    <a href="{{ route('shelfbar') }}">ShelfTag/Barcode Print</a>
                                </li>
                                <li>
                                    <a href="{{ route('pdtscan') }}">PDT Scan</a>
                                </li>
                                <li>
