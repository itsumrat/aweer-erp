...
class DCRequisitionController extends Controller
{
        private $root = 'requisition/dc/';
    /**
    ...
    public function dcRequisitionTableData(Request $request){
        $store_id = $request->store_id;
       $users = Requisition::where('type', 2)->with(['requisition_items','requisition_items.item' ,'requisition_items.item.prices']);
       // dd($users);
                ...
                ->editColumn('action', function(Requisition $req){
                    return '                                            <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="itemActionDropdown">
                                                        ...
                                                        <a class="dropdown-item" href="dc_requisition/'.$req->id.'/edit">Edit</a>
