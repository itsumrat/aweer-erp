...
class PurchaseController extends Controller
{
    ...
    public function purchaseOrderTableData(Request $request){
       ...
       $purchase = Purchase::with(['vendor', 'purchase_items', 'purchase_items.item', 'purchase_items.item', 'foc_items','foc_items.item']);
                ...
                ->editColumn('grand_total', function(Purchase $req){
                    ...
                    if(!empty($items)){
                        foreach ($items as $key => $item) {
                            $single_item_total =  ($item->quantity * $item->final_cost);
