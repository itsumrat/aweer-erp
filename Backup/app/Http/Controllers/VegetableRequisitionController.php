...
class VegetableRequisitionController extends Controller
{
    private $root = 'requisition/vegetables/';
    /**
    ...
    public function VegetableRequisitionTableData(Request $request){
        $store_id = $request->store_id;
       $users = Requisition::where('type', 1)->with(['requisition_items','requisition_items.item' ,'requisition_items.item.prices']);
       if ($store_id != 0) {
                ...
                ->editColumn('action', function(Requisition $req){
                    return '<div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="itemActionDropdown">
                                                        ...
                                                        <a class="dropdown-item" href="/vegetable_requisition/'.$req->id.'/edit">Edit</a>
