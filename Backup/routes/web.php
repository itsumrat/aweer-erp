...
Route::get('cash_flow', 'FinanceController@cashFlow')->name('cash_flow');
Route::get('cash_flow_data', 'FinanceController@cashFlowData')->name('cash_flow_data');
Route::get('bank_flow', 'FinanceController@bankFlow')->name('bank_flow');
Route::get('bank_flow_data', 'FinanceController@bankFlowData')->name('bank_flow_data');
