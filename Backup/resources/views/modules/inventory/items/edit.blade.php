                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="name" value="{{ $item_info->name }}">
                                                                @error('name')
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="code" value="{{ $item_info->code }}">
                                                                    @error('code')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="evalucation">
                                                                        <option {{ ($item_info->evaluation == 'something')?'selected':'' }}>something</option>
                                                                        <option {{ ($item_info->evaluation == 'Ev 2')?'selected':'' }}>Ev 2</option>
                                                                        <option {{ ($item_info->evaluation == 'Ev 3')?'selected':'' }}>Ev 3</option>
                                                                        <option {{ ($item_info->evaluation == 'Ev 4')?'selected':'' }}>Ev 4</option>
                                                                    </select>
                                                                    @error('evalucation')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="avg_cost" value="{{ $item_info->prices->avg_cost }}">
                                                                    @error('avg_cost')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="last_grn_cost" value="{{ $item_info->prices->last_grn_cost }}">
                                                                    @error('last_grn_cost')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                                </div>
...
const app = new Vue({
    ...
    data: {
        ...
        final_cost: {{ $item_info->prices->final_cost }},
        final_price: {{ $item_info->prices->final_price }},
        markup: {{ $item_info->prices->markup }},
        price_without_tax: '{{ $item_info->prices->price_without_tax }}',
        tax: '{{ $tax }}',
        vendor_list: [
            {
                serial: 1,
