                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ route('dc_requisition.create') }}" role="tab" aria-controls="pills-dc" aria-selected="false">DC</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-vegetables" role="tabpanel" aria-labelledby="pills-vegetables-tab">
                                        <form action="{{ route('dc_requisition.store') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
