...
@section('title', 'Dashboard - DSD Requisition Create')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('vegetable_requisition.create') }}" role="tab" aria-controls="pills-vegetables" aria-selected="true">Vegetables</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('dc_requisition.create') }}" role="tab" aria-controls="pills-dc" aria-selected="false">DC</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ route('dsd_requisition.create') }}" role="tab" aria-controls="pills-dsd" aria-selected="false">DSD</a>
                                    </li>
                                </ul>

                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-vegetables" role="tabpanel" aria-labelledby="pills-vegetables-tab">
                                        <form action="{{ route('dsd_requisition.store') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
