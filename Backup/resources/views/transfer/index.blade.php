...
@section('title', 'Dashboard - Transfer List')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Transfer List (<span id="loc-text">All Locations</span>)</h5>
